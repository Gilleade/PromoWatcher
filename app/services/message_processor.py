...
def _apply_product_matching(conn: sqlite3.Connection, promotion_id: int,
    ...
    price_point = record_price_point(
        ...
        installment_price=float(parsed.installment_price) if parsed.installment_price is not None else None,
        installment_no_interest=parsed.installment_no_interest,
